...
What sets it apart is an executable, research-grounded risk engine, shipped as four MCP tools an agent can call directly:
...
```bash
cd examples && make verify   # 110 checks: TypeScript mint, Rust hook, mint inspector
```
